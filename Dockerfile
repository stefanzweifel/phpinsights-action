...
LABEL "com.github.actions.name"="PHP Insights Action"
LABEL "com.github.actions.description"="Run PHP Insights"
LABEL "com.github.actions.icon"="check"
LABEL "com.github.actions.color"="blue"

LABEL "repository"="http://github.com/stefanzweifel/phpinsights-action"
LABEL "homepage"="http://github.com/stefanzweifel/phpinsights-action"
